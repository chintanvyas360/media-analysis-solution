...
class StatusModal extends Component {
  ...
  componentWillUnmount() {
    ...
    this.getVizonAnalysisConfig();
  }

  getVizonAnalysisConfig() {
    let vizonAnalysisConfig = this.props.getVizonAnalysisConfig();
    this.setState({vizonAnalysisConfig: vizonAnalysisConfig});
  }
  ...
  render() {
    let console_link = [this.state.vizonAnalysisConfig.SOLUTION_CONSOLE_LINK, this.props.objectid].join(':');
    ...
    if (this.props.format === '') {
      ...
      return (
        <div>
          <ModalHeader toggle={this.toggle}>Analysis Progress</ModalHeader>
          <ModalBody>
